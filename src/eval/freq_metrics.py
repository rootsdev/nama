...
def calc_avg_precision_recall(query_names: List[str], name2codes: Dict[str, Set[str]], code2names: Dict[str, Set[str]],
                                 df: pd.DataFrame) -> Tuple[float, float, float, float]:
