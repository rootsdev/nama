...
from nama.data.constants import (
...
def normalize(
    ...
    handle_patronymics: bool = True,
    dont_return_empty: bool = True,
) -> list[str]:
    ...
    # merge prefixes
    pieces = merge_surname_prefixes(pieces) if is_surname else merge_given_prefixes(pieces)
    # remove noise words
