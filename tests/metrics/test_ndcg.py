...
def test_ndcg_k_is_zero():
    ...
    with pytest.raises(Exception):
        metrics.ndcg_k(relevant=relevant,
...
def test_ndcg_k_none():
    ...
    ndcg_3 = metrics.ndcg_k(relevant=relevant,
                            relevancy_scores=relevancy_scores,
                            predicted=predicted,
                            k=6)
    ndcg_score = metrics.ndcg_k(relevant=relevant,
                                relevancy_scores=relevancy_scores,
                                predicted=predicted)
...
def test_ndcg_k_reals():
    ...
    ndcg_10 = metrics.ndcg_k(relevant=relevant,
                             relevancy_scores=relevancy_scores,
                             predicted=predicted,
                             k=10)
    ndcg_3 = metrics.ndcg_k(relevant=relevant,
                            ...
                            predicted=predicted,
                            k=3)
    ndcg_1 = metrics.ndcg_k(relevant=relevant,
                            relevancy_scores=relevancy_scores,
                            predicted=predicted,
                            k=1)
...
def test_ndcg_k_reals_one_hit():
    ...
    ndcg_8 = metrics.ndcg_k(relevant=relevant,
                            relevancy_scores=relevancy_scores,
                            predicted=predicted,
                            k=8)
...
def test_ndcg_k_integers():
    ...
    ndcg_3 = metrics.ndcg_k(relevant=relevant,
                            ...
                            predicted=predicted,
                            k=3)
    ndcg_2 = metrics.ndcg_k(relevant=relevant,
                            relevancy_scores=relevancy_scores,
                            predicted=predicted,
                            k=2)
    ndcg_1 = metrics.ndcg_k(relevant=relevant,
...
def test_ndcg_k_one_hit():
    ...
    predicted = [0, 1, 10, 2]
    ndcg_4 = metrics.ndcg_k(relevant=relevant,
                            relevancy_scores=relevancy_scores,
                            predicted=predicted,
                            k=4)
    ndcg_1 = metrics.ndcg_k(relevant=relevant,
